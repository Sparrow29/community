...
public class DiscussPostController implements CommunityConstant {
    ...
    public String getDiscussPost(@PathVariable("discussPostId") int discussPostId, Model model, Page page) {
        ...
        int likeStatus = 0;
        if (loginUser != null) {
            likeStatus = likeService.findEntityLikeStatus(loginUser.getId(), ENTITY_TYPE_POST, discussPostId);
        }
            ...
            for (Comment comment : commentList) {
                ...
                if (replyList != null) {
                    for (Comment reply : replyList) {
                        ...
                        likeStatus = 0;
                        if (loginUser != null) {
                            likeStatus = likeService.findEntityLikeStatus(loginUser.getId(), ENTITY_TYPE_COMMENT, reply.getId());
                        }
     ...
     * 加精帖子
     */
    @RequestMapping(path = "/elite", method = RequestMethod.POST)
    @ResponseBody
    public String setElite(int id) {
        discussPostService.setElite(id);
    ...
    public String setDelete(int id) {
        discussPostService.setDelete(id);
