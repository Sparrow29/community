...
public class RedisTests {
    ...
    public void testHashes() {
        ...
        redisTemplate.opsForHash().put(redisKey, "username", "zhaohong");
    ...
    public void testZSets() {
        ...
        redisTemplate.opsForZSet().add(redisKey, "bbb", 30);
        redisTemplate.opsForZSet().add(redisKey, "ccc", 40);
        redisTemplate.opsForZSet().add(redisKey, "ddd", 80);
        redisTemplate.opsForZSet().add(redisKey, "eee", 90);
    ...
    public void testTransaction() {
        Object result = redisTemplate.execute(new SessionCallback() {
            ...
            public Object execute(RedisOperations redisOperations) throws DataAccessException {
                ...
                redisOperations.opsForSet().add(redisKey, "asd");
                redisOperations.opsForSet().add(redisKey, "wqer");
                redisOperations.opsForSet().add(redisKey, "asqwerd");
